...
Filename pattern (written under the `journal/` folder):
```
journal/logs/<instrument>/YYYY/MM-DD.md       ← first session of the day
journal/logs/<instrument>/YYYY/MM-DD-2.md     ← second session same day
journal/logs/<instrument>/YYYY/MM-DD-3.md     ← third session same day
```
